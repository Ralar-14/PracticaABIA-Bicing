...
class ProblemParameters(object):
    def __init__(self, num_bicicletas: int, num_furgonetas: int, num_estaciones: int, seed: int = 1, initial_strat: int = 0, free_gas: bool = False, operators_used: List[int] = [1]*6):
